...
namespace Employee_Management_Alpha_1._0
{
    public partial class AddEmployee : Form
    {
        ...
        private void btnAddEmployee_Click(object sender, EventArgs e)
        {
            ...
            employeeManagement.AddEmployee(tbFirstName.Text, tbLastName.Text, dtpEmployee.Value, tbBSN.Text, tbPosition.Text, Convert.ToInt32(tbWorkingH.Text), tbPhone.Text, tbAddress.Text, tbEmail.Text, tbEmergencyN.Text, tbContactR.Text, tbEmergencyNr.Text, tbCertifications.Text, tbLanguage.Text, tbContractType.Text, tbDuration.Text);
            else
            {
